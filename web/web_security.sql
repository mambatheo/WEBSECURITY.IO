...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 07, 2021 at 11:32 AM
...
INSERT INTO `login` (`id`, `firstName`, `lastName`, `age`, `password`) VALUES
(1, 'Theogene', 'MURAGIJIMANA', 34, '1234'),
(2, 'mamba', 'mamba', 5, '5647'),
(3, 'Bernadette', 'MUKAGAHAMANYI', 3, '123456'),
(4, 'Bernadette', 'kagwiza', 35, 'FDHHHHHHH'),
(5, 'mamba', 'mamba', 5, 'yt'),
(6, '', '', 0, '23434');
